...
@section('content')
    ...
    <?php
		...
		"placeholder" => "-"
            ...
            [
                "name" => "",
                "display" => "",
                "html" => '<hr><h3>Please tab your card.</h3>For Confirm your data'
            ],
            [
                "name" => "rfid",
                "display" => "RDIF Card Code",
                "required" => true
            ]
        );
    ?>
    ...
    <form action="{{ url('/magic/first-time-registration/register') }}" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <p style="color: red;" class="form-control-static"><i class="fa fa-exclamation-triangle"></i> กรุณาตรวจสอบว่าข้อมูลที่กรอกมาถูกต้องทั้งหมดก่อนส่งข้อมูล</p>
            </div>
        </div>
        <div class="form-group" >
            <label class="col-sm-3 control-label"></label>
