...
@section('content')
    ...
    @if(isset($UserNotFound))
        <div class="alert alert-danger">ไม่เจอผู้ใช้งาน / Username not found.</div>
    @endif

    <form action="" method="post" class="form-horizontal">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="form-group">
            <label for="project-th" class="col-sm-2 col-sm-offset-1 control-label">Username</label>
            <div class="col-sm-6"><input type="text" class="form-control" name="username" pattern=".{7,7}" placeholder="Username"></div>
        </div>
        <div class="form-group">
            <label for="password" class="col-sm-2 col-sm-offset-1 control-label">New password</label>
            <div class="col-sm-6">
