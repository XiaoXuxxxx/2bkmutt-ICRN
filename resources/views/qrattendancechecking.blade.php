...
?>
@extends('layouts.app')
@section('title', 'QRAttendance Checking')
@section('content')
@include('components.title', [
"title" => "QR-CODE Attendance Checking"
])
<?php
use App\UserProfile;
...
<div class="attendance-checking">
  ...
  <div class="row" id="check" style="margin-top: 16px;">
    <div class="col-sm-12">
      <div class="status-label">QRCODE READER</div>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div id="output" >
        ...
        <div hidden><b>Data:</b> <span id="XoutputData"></span></div>
      </div>
    </div>
    <div class="col-md-6">
...
<script src="{{ asset('js/qr-attendance-checking.js') }}" type="text/javascript"></script>
